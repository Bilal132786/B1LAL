...
def rcrack(uid,pwx,tl):
    ...
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=sygaZaYYNEMcl0Gzqvfb7XLE; sb=sygaZSgV1u4FmP9KFmVGs1au; m_pixel_ratio=1.9250000715255737; wd=562x852; fr=0Lc9VNkqP0sAtv8AD..BlGiiz.MV.AAA.0.0.BlGis_.AWUudPI57TI',
